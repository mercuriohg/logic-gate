...
<body>
      ...
      <img src="../img/logic-gate.png" alt="Logo do Logic Gate" id="logo" height="100em">
        ...
        <ul id="list-ul">
            ...
            <li><a href="../pages/projeto.php" class="btn">Projeto</a></li>
        </ul>
    </header>
        <main id="container-main">
            <div id="login-container">
            <form action="/src/api/cadastro_validate.php" method="post" id="login-form">
            <h2>Cadastro</h2>
            <div id="user-box">
              <label>Usuário:</label>
            ...
            <div id="password-box">
              ...
              <input type="password" id="confirm-password" placeholder="Confirmar Senha" class="input-user" name="confirm-password">
                </div>
                <div id="button-box">
